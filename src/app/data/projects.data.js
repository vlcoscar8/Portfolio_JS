export const projectsData = [
    ...
    },
    {
        ...
        description:
            "An e-commerce about sneakers where the you can registered to buy a shoe adding to cart and a personal account view where the user can check the products bought and manage the personal information. This project is an start-to-end project with not only frontend development, but also backend with an APi to manage all the data used in the application.",
        stack: [
            {
                name: "Angular",
